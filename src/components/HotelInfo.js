...
const HotelInfo = () => {
  ...
  useEffect(() => {
    fetch(
      "https://ly9cioaa8j.execute-api.us-east-2.amazonaws.com/Production/services"
    )
      .then((resp) => resp.json())
      .then(setServicesData);

    fetch(
      "https://ly9cioaa8j.execute-api.us-east-2.amazonaws.com/Production/accessibilities"
    )
      .then((resp) => resp.json())
